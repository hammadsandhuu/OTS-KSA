    ...
    return (
        <footer className={`creative-footer-style ${buttonCls} p-relative z-index-1`} style={{ backgroundColor: "#F6F6F9" }}>
            ...
            <div className="creative-footer-text d-none d-lg-block">
                <p>We are here to help you, send me back up 👆</p>
            </div>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6">
                            <div className="tp-footer-widget tp-footer-col-3 pb-40 mb-30 tp_fade_anim" data-delay=".7" data-on-scroll="3">
                                ...
                                <div className="tp-footer-widget-info">
                                    <Link href="mailto:ocean@tradingservices.com">Shahr.azim@otsksa.com</Link>
                                    <Link href="tel:+971526000000">+(971) 52 600 0000</Link>
                                </div>
                                <div className="tp-footer-widget-info">
                                    <Link href="https://www.google.com/maps/" target="_blank">Surooh Business Center Floor 3, Office 9 Hael Street 22321 Jeddah Saudi Arabia</Link>
                                </div>
                            </div>
                        </div>
                    </div>
